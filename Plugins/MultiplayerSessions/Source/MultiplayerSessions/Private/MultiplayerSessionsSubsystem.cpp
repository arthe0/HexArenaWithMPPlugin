...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	//Store the delegate in a FDelegateHandle to have ability to remove it later from delegate list
	...
	LastSessionSettings->bUseLobbiesIfAvailable = true; //Crashes if ignored?
